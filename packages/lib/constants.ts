...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://vitap.ac.in";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "cal.null_chapter";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "nullchapter@vitap.ac.in";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Null Chapter";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "NC";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "cal.null_chapter";
...
export const LOGO = "/null-chapter-logo.svg";
export const LOGO_DARK = "/null-chapter-logo-dark.svg";
export const LOGO_ICON = "/null-chapter-icon.svg";
...
export const ROADMAP = "https://nullchapter.github.io";
export const DESKTOP_APP_LINK = "https://nullchapter.github.io";
export const JOIN_COMMUNITY = "https://github.com/NullChapter";
export const POWERED_BY_URL = "https://nullchapter.github.io";
export const DOCS_URL = "https://nullchapter.github.io/about";
export const DEVELOPER_DOCS = "https://nullchapter.github.io";
...
export const DEFAULT_LIGHT_BRAND_COLOR = "#00D4FF";
export const DEFAULT_DARK_BRAND_COLOR = "#0A0E17";
