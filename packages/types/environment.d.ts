declare namespace NodeJS {
  interface ProcessEnv {
    ...
    readonly NEXT_PUBLIC_APP_NAME: string | "cal.null_chapter";
    readonly NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS: string | "nullchapter@vitap.ac.in";
    readonly NEXT_PUBLIC_COMPANY_NAME: string | "Null Chapter";
